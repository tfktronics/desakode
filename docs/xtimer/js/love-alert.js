...
`<style>
    ...
    .bg-love-alert:before {
        content: "";position: absolute;z-index: -1;top: 0;bottom: 0;left: 0;right: 0;background: url(data/love-alert.webp) no-repeat center center;-webkit-background-size: 100% 100%;opacity: 0.2;
    }
</style>
